...
function App() {
  ...
  return (
    ...
    >
      ...
      /> {/* YouTube video with single video */}
...
<ContentBlock
      ...
      /> {/* YouTube video with multiple videos */}
      ...
      <ContentBlock
        ...
        color="indigo"
      >
        This is a generic block with a blue background.
      </ContentBlock>
      ...
      <ContentBlock
        ...
        noteType="primary"
        color='indigo'
        content="This is a note block with a primary style."
      >
      </ContentBlock>
      ...
      <ContentBlock
        title="File Structure Block"
        type="FileStructureView"
        color='indigo'
        filestructure={{
          "src":{
            "App.tsx": "Here is the main app file.",
            "components": {
              "Button.tsx": "This is a button component.",
              "Input.tsx": "This is an input component."
            }
          }
        }}
      />
